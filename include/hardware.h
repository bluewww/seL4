...
/* These symbols are generated by the linker and mark a region to be
 * reserved statically for kernel image clones */
extern char ki_clone_mem_start[1];
extern char ki_clone_mem_end[1];
#endif
